...
<?php require_once '../includes/chat-header_1.php'?>

<body>
<?php  require_once '../includes/top-nav.php'?>
<?php  require_once '../includes/chat-side-nav.php'?>

<div class="page-content page-container fixed-top mt-5" id="page-content">
  <div class="padding">
